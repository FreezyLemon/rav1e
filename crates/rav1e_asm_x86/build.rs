...
"
  ...
  let asm_files = &[
    ...
    "src/cdef_sse.asm",
    "src/cdef16_avx2.asm",
    "src/cdef16_avx512.asm",
    "src/cdef16_sse.asm",
    "src/ipred_avx2.asm",
    "src/ipred_avx512.asm",
    "src/ipred_sse.asm",
    "src/ipred16_avx2.asm",
    "src/ipred16_avx512.asm",
    "src/ipred16_sse.asm",
    "src/itx_avx2.asm",
    "src/itx_avx512.asm",
    "src/itx_sse.asm",
    "src/itx16_avx2.asm",
    "src/itx16_avx512.asm",
    "src/itx16_sse.asm",
    "src/looprestoration_avx2.asm",
    "src/looprestoration_avx512.asm",
    "src/looprestoration_sse.asm",
    "src/looprestoration16_avx2.asm",
    "src/looprestoration16_avx512.asm",
    "src/looprestoration16_sse.asm",
    "src/mc_avx2.asm",
    "src/mc_avx512.asm",
    "src/mc_sse.asm",
    "src/mc16_avx2.asm",
